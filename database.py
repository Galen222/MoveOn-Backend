...
class Usuario(Base):
    ...
    Atributos:
        ...
        acepta_terminos: Registro de si el usuario aceptó los Términos y la Política de Privacidad.
        version_terminos: Versión del texto legal aceptado en el momento del registro.
...
class SesionRefresh(Base):
    ...
    reemplazada_por_jti: Mapped[Optional[str]
