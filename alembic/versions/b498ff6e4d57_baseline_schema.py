...
def upgrade() -> None:
    ...
    sa.CheckConstraint('client_local_id IS NULL OR char_length(btrim(client_local_id)) BETWEEN 1 AND 64', name='ck_actividades_client_local_id_len'),
...
def downgrade() -> None:
    ...
    op.drop_index('uq_actividades_usuario_client_local_id', table_name='actividades', postgresql_where=sa.text('client_local_id IS NOT NULL'))
