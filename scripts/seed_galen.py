...
"""
Seeder de 7 rutas completas para un usuario de pruebas llamado Galen.
...
- Después crea 7 actividades con polilíneas válidas.
...
async def crear_rutas_galen() -> None:
    """Inicializa la BD, garantiza el usuario Galen y crea las 7 rutas de prueba."""
