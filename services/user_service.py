...
class UserService:
    ...
    def obtener_perfil(self, db: Session, usuario_actual: str):
    ...
    def actualizar_perfil_usuario(self, db: Session, usuario: database.Usuario, datos: schemas.ActualizarPerfil):
    ...
    def eliminar_cuenta(self, db: Session, usuario: database.Usuario):
